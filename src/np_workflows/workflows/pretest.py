try:
    ...
    from np_workflows.workflows.shared.photodoc import (
        capture_photodoc_enter,
        capture_photodoc_input,
        review_photodoc_enter,
        review_photodoc_input,   
    )
...
def capture_photodoc_0_enter(state_globals) -> None:
    npxc.set(state_globals, photodoc_label='pretest_0')
    capture_photodoc_enter(state_globals)
    
def capture_photodoc_0_input(state_globals) -> None:
    capture_photodoc_input(state_globals)
    
def review_photodoc_0_enter(state_globals) -> None:
    review_photodoc_enter(state_globals)
    
def review_photodoc_0_input(state_globals) -> None:
    review_photodoc_input(state_globals)
    
def capture_photodoc_1_enter(state_globals) -> None:
    npxc.set(state_globals, photodoc_label='pretest_1')
    capture_photodoc_enter(state_globals)
    
def capture_photodoc_1_input(state_globals) -> None:
    capture_photodoc_input(state_globals)

def review_photodoc_1_enter(state_globals) -> None:
    review_photodoc_enter(state_globals)
    
def review_photodoc_1_input(state_globals) -> None:
    review_photodoc_input(state_globals)
