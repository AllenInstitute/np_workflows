"""
Stub functions generated by wfl2py.
*_enter and *_exit functions inherit a shared namespace referenced via the global keyword.
"""
...
def initialize_input(state_globals):
    ...
    mouse_director_proxy = Proxy("localhost:9000")  # TODO: config this
...
def date_string_check_input(state):
    ...
    mapped_lims_location = rf"{npxc.config['mapped_lims_location']}/{state['external']['session_name']}"
